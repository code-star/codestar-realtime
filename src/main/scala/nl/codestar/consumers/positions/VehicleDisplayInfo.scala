...
case class VehicleDisplayInfoTags(id: String, time: Long, text: String)
...
object VehicleDisplayInfo {
  ...
  def fromInfo(id: String, i: VehicleInfo) =
    VehicleDisplayInfo("node", id, i.latitude, i.longitude, VehicleDisplayInfoTags(id, i.time.toEpochMilli, ""))
